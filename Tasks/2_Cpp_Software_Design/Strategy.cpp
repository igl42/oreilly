...
int main()
{
   ...
   shapes.emplace_back(
      std::make_unique<Circle>( 2.3, std::make_unique<TestDrawStrategy>(gl::Color::red) ) );
   shapes.emplace_back(
      std::make_unique<Square>( 1.2, std::make_unique<TestDrawStrategy>(gl::Color::green) ) );
   shapes.emplace_back(
      std::make_unique<Circle>( 4.1, std::make_unique<TestDrawStrategy>(gl::Color::blue) ) );
