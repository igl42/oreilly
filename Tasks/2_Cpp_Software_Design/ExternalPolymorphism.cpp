...
{
 public:
   explicit TestDrawStrategy( gl::Color color ) : color_(color) {}
...
int main()
{
   ...
   shapes.emplace_back( std::make_unique<Circle>( 2.3, TestDrawStrategy(gl::Color::red) ) );
   shapes.emplace_back( std::make_unique<Square>( 1.2, TestDrawStrategy(gl::Color::green) ) );
   shapes.emplace_back( std::make_unique<Circle>( 4.1, TestDrawStrategy(gl::Color::blue) ) );
