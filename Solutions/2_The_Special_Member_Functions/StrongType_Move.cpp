...
*         non-strong types (e.g. int -> StrongType<int>, ...). Bonus task: define the
...
*         strong types (e.g. StrongType<unsigned int> -> StrongType<int>, ...). Bonus task:
*         define the corresponding assignment operators.
*
**************************************************************************************************/
...
class StrongType final
{
 ...
 public:
   ...
   // Obsolete in the presence of the forwarding reference constructor below
   /*
   ...
   */
   ...
   template< typename U, EnableIfIsConvertible_t<U> = true >  // C++17
   //template< typename U >  // C++20
