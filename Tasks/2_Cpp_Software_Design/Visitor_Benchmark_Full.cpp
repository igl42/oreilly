...
namespace std_variant_solution {
   ...
   using Shape = std::variant<Circle,Ellipse,Square,Rectangle>;
   ...
   void translate( Shape& s, const Vector2D& v )
   {
      ...
      else if( Ellipse* ellipse = std::get_if<Ellipse>(&s) ) {
         ellipse->center = ellipse->center + v;
      }
      else if( Square* square = std::get_if<Square>(&s) ) {
         square->center = square->center + v;
      }
      else if( Rectangle* rectangle = std::get_if<Rectangle>(&s) ) {
...
namespace mpark_variant_solution {
   ...
   using Shape = mpark::variant<Circle,Ellipse,Square,Rectangle>;
...
namespace boost_variant_solution {
   ...
   using Shape = boost::variant<Circle,Ellipse,Square,Rectangle>;
