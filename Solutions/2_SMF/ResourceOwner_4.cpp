...
class ResourceOwner
{
 public:
      ...
      , m_name{ other.m_name }  // Copy construction of the string
   {
      ...
      m_resource.reset( new Resource( *other.m_resource ) );  // Copy construction of the resource
   }
   ...
   {
      assert( other.m_resource );
      m_resource.reset( new Resource( std::move(*other.m_resource) ) );  // Move construction of the resource
   }
   ...
   ResourceOwner& operator=( ResourceOwner&& other ) noexcept
   {
      ...
      *m_resource = std::move(*other.m_resource);  // Move assignment of the resource
      return *this;
   }
