...
int main()
{
   ...
   shapes.emplace_back(
      std::make_unique<ShapeModel<Circle,TestDrawStrategy>>(
         Circle{2.3}, TestDrawStrategy(gl::Color::red) ) );
   shapes.emplace_back(
      std::make_unique<ShapeModel<Square,TestDrawStrategy>>(
         Square{1.2}, TestDrawStrategy(gl::Color::green) ) );
   shapes.emplace_back(
      std::make_unique<ShapeModel<Circle,TestDrawStrategy>>(
         Circle{4.1}, TestDrawStrategy(gl::Color::blue) ) );
