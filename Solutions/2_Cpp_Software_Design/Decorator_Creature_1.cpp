 ...
 public:
   ...
   Attack attack() const override
   {
      if( creature().attack() > 1 ) {
         return Attack{creature().attack() + 1};
      }
      else {
   ...
   : public ModifiedCreature
{
 public:
   ...
   Speed speed() const override
   {
      return Speed{ creature().speed()+2 };
   }
};
   ...
   : public ModifiedCreature
{
 public:
   ...
   Attack attack() const override
   {
      return Attack{ creature().attack()+2 };
   }
};
...
int main()
{
   std::unique_ptr<Creature> knight =
      std::make_unique<StrengthEnchantment>(
         std::make_unique<ShoesOfAgility>(
            std::make_unique<IceSword>(
