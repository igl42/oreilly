...
class ElectricCar
{
 public:
   ...
   ElectricCar& operator=( ElectricCar&& other );
 ...
 private:
   ...
   Impl const& pimpl() const { return reinterpret_cast<Impl const&>( buffer_ ); }
...
{
   std::construct_at( &pimpl(), other.pimpl() );
}
...
{
   std::construct_at( &pimpl(), std::move(other.pimpl()) );
}

ElectricCar& ElectricCar::operator=( ElectricCar&& other )
{
